...
Singleton is an [anti-pattern](https://en.wikipedia.org/wiki/Singleton_pattern). Paraphrased from Brian Button:
 ...
 3. They inherently cause code to be tightly [coupled](#user-content-single-responsibility-principle-srp). This makes faking them out under test rather difficult in many cases.
